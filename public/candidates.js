...
function updateCandidate(applicantId) {
  ...
  document.getElementById("saveButton").onclick = function() {
    const updatedCandidate = {
      ...
      dateOfPhoneScreen: document.getElementById("dateOfPhoneScreen").value || null,
  ...
  Promise.all([
    ...
    function renderCandidates(filteredCandidates) {
      ...
      filteredCandidates.forEach((candidate) => {
          ...
          let profileOwnerCell = `<td class="sticky-col sticky-col-1"><input type="text" id="profileOwner-${candidate.applicantId}" value="${candidate.profileOwner}" ${!isAdmin ? "disabled" : ""}></td>`;
          ...
          row.innerHTML = 
              `${profileOwnerCell}
              <td class="sticky-col sticky-col-2"><i class="far fa-edit action-icon" style="color: blue;" onclick="updateCandidate(${candidate.applicantId})"></i></td>
              ...
              <td><input type="date" id="dateOfPhoneScreen-${candidate.applicantId}" value="${formatDate(candidate.dateOfPhoneScreen)}"></td>
